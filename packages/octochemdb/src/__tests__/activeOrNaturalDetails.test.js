...
test('activeOrNaturalDetails', async () => {
  ...
  expect(fields).toStrictEqual([
    ...
    'charge', 'unsaturation',
    'mf', 'bioactive',
    'noStereoOCL', 'nbPatents',
    'patents', 'cas',
    'nbPubmeds', 'nbMassSpectra',
    'nbTaxonomies', 'nbActivities',
    'kwMeshTerms', 'pubmeds',
    'massSpectraRefs', 'kwBioassays',
    'kwActiveAgainst', 'kwTaxonomies',
    'activities', 'taxonomies',
    'compounds'
  ])

  //console.log(entry.data.pubmeds[0])
});