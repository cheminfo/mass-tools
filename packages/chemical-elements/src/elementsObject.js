...
module.exports = {
  ...
  Tc: { number: 43, mass: null, name: 'Technetium' },
  Ru: {
    number: 44,
  ...
  Pm: { number: 61, mass: null, name: 'Promethium' },
  Sm: {
    number: 62,
  ...
  Po: { number: 84, mass: null, name: 'Polonium' },
  At: { number: 85, mass: null, name: 'Astatine' },
  Rn: { number: 86, mass: null, name: 'Radon' },
  Fr: { number: 87, mass: null, name: 'Francium' },
  Ra: { number: 88, mass: null, name: 'Radium' },
  Ac: { number: 89, mass: null, name: 'Actinium' },
  Th: {
    number: 90,
    mass: 232.0380558,
    name: 'Thorium',
  ...
  Np: { number: 93, mass: null, name: 'Neptunium' },
  Pu: { number: 94, mass: null, name: 'Plutonium' },
  Am: { number: 95, name: 'Americium', mass: null },
  Cm: { number: 96, name: 'Curium', mass: null },
  Bk: { number: 97, name: 'Berkelium', mass: null },
  Cf: { number: 98, name: 'Californium', mass: null },
  Es: { number: 99, name: 'Einsteinium', mass: null },
  Fm: { number: 100, name: 'Fermium', mass: null },
  Md: { number: 101, name: 'Mendelevium', mass: null },
  No: { number: 102, name: 'Nobelium', mass: null },
  Lr: { number: 103, name: 'Lawrencium', mass: null },
  Rf: { number: 104, name: 'Rutherfordium', mass: null },
  Db: { number: 105, name: 'Dubnium', mass: null },
  Sg: { number: 106, name: 'Seaborgium', mass: null },
  Bh: { number: 107, name: 'Bohrium', mass: null },
  Hs: { number: 108, name: 'Hassium', mass: null },
  Mt: { number: 109, name: 'Meitnerium', mass: null },
  Ds: { number: 110, name: 'Darmstadtium', mass: null },
  Rg: { number: 111, name: 'Roentgenium', mass: null },
  Cn: { number: 112, name: 'Copernicium', mass: null },
  Nh: { number: 113, name: 'Nihonium', mass: null },
  Fl: { number: 114, name: 'Flerovium', mass: null },
  Mc: { number: 115, name: 'Moscovium', mass: null },
  Lv: { number: 116, name: 'Livermorium', mass: null },
  Ts: { number: 117, name: 'Teennessine', mass: null },
  Og: { number: 118, name: 'Oganesson', mass: null },
};
